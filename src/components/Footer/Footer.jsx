...
const Footer = () => {
    ...
    return (
        ...
        <div className="FooterText">
                <h2>I am a very open and talkative.</h2> 
            <p>So if you are interested in my person or have any questions, please sent me a message and let's  <a href="#contact" onClick={()=> !state ? setState(true) : null}>chat!<svg viewBox="0 0 70 36">
            <path
